...
async function processQueue() {
    ...
    if (processState.processedIndices.size >= processState.total) {
        processState.status = 'completed'; saveCheckpoint(); updateProgressUI(true); Swal.fire('Hoàn thành', 'Xử lý xong! Bạn có thể bấm Kiểm tra ID để rà lại các ID đã import.', 'success');
